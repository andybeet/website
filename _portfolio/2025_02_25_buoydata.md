...
Currently the package pulls all data from ERDDAP which combines historic data, defined as data from January - December for all years prior to the current year, with real time data, defined as the current year.

* Github: 
  * View the [buoydata](https://github.com/NOAA-EDAB/buoydata?tab=readme-ov-file#buoydata-) R package code
  * View the [buoydata](https://noaa-edab.github.io/buoydata/) documentation