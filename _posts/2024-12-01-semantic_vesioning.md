...
* Changes in MINOR component refer changes such as new features. These new features integrate with the package, they complement other features already present, and do NOT break existing code.
