...
Simply put, cron jobs are jobs/tasks (pieces of executable code, on Liux or Mac) that are run on a predefined schedule. For example,
...
In the context of GitHub they can be used in GitHub action to run any code on whatever schedule you'd like.
